...
if __name__ == "__main__":
    ...
    # c.set_team_members_call("AUSTRALIA", "ipfs://bafkreifgh3ft6l2cmphogmhbbw6z65pr26qxvy3bm3zhypljo7td2gfhui")
    # print("================ NEXT CALL =====================")
    # c.get_team_members_call("AUSTRALIA")
    print("================ NEXT CALL =====================")
    c.add_user_squad_call("ipfs://bafkreigqcprpdr4encqco7fxqczzcrly3is6coqi43zi66jvrxxzbz3see")
    print("================ NEXT CALL =====================")
